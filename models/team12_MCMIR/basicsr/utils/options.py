...
def parse_options(root_path, is_train=True):
    ...
    # setattr(args, 'data_dir', opt['dataroot_gt'][0])  # Set data directory
    setattr(args, 'img_size', opt.get('gt_size', 192))  # Set image size
    setattr(args, 'batch_size', opt.get('batch_size_per_gpu', 4))  # Set batch size
    setattr(args, 'num_workers', opt.get('num_worker_per_gpu', 32))  # Set num_workers
